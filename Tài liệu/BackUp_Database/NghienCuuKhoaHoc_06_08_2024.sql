...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 06, 2024 lúc 02:20 PM
...
(1, '99998', '2024-08-05', 'Đang giữ chức danh'),
...
('99998', 16, 'Bao TK', 'baoquocone@gmail.com', '0256413987', ''),
...
--
ALTER TABLE `loai_danh_muc`
  MODIFY `MA_LOAI_DANH_MUC` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ty_le_quy_doi_gio_chuan`
  MODIFY `MA_QUY_DOI` int(11) NOT NULL AUTO_INCREMENT;

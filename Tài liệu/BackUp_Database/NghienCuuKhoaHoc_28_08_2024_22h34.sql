...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 28, 2024 lúc 05:34 PM
...
ALTER TABLE `hockynienkhoa`
  ...
  ADD KEY `FK_PHAN_CONG_HOC_KY` (`MAPHANCONG`);
...
--
-- Các ràng buộc cho bảng `hockynienkhoa`
--
ALTER TABLE `hockynienkhoa`
  ADD CONSTRAINT `FK_PHAN_CONG_HOC_KY` FOREIGN KEY (`MAPHANCONG`) REFERENCES `bangphancong` (`MAPHANCONG`);

...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 15, 2024 lúc 05:45 PM
...
CREATE TABLE `khunggiochuan` (
  ...
  `GIOGIANGDAY__CHUAN` int(11) DEFAULT NULL,
...
INSERT INTO `monhoc` (`MAMONHOC`, `TENMONHOC`, `SOTINCHILYTHUYET`, `SOTINCHITHUCHANH`) VALUES
(26, 'Giáo dục thể chất 2*', 0, 1),
(27, 'Kinh tế chính trị Mác - Lênin', 2, 0),
(28, 'Anh văn không chuyên 2', 2, 2),
(29, 'Phương pháp NCKH', 1, 1),
(30, 'Tiếng Việt thực hành', 1, 1),
(31, 'Logic học đại cương', 1, 1),
(32, 'Toán rời rạc', 1, 1),
(33, 'Đại số đại cương', 1, 1),
(34, 'Cấu trúc dữ liệu và giải thuật', 2, 2);
...
('tinthanhtv2014@gmail.com', '00243', NULL, 'Admin', 'Đang hoạt động'),
...
--
ALTER TABLE `chuongtrinhdaotao`
  MODIFY `MACHUONGTRINH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `khunggiochuan`
  MODIFY `MAKHUNG` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `monhoc`
--
ALTER TABLE `monhoc`
  MODIFY `MAMONHOC` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 13, 2024 lúc 11:11 AM
...
(1, '99997', '2024-08-09', 'Đang giữ chức danh'),
...
INSERT INTO `thoigian_xacnhan` (`MA_THOIGIAN_XACNHAN`, `THOIGIANBATDAU`, `THOIGIANKETTHUC`, `TEN_KHOA`) VALUES
(8, '2024-08-12 21:44:00', '2024-08-30 21:44:00', 'Khoa Kỹ Thuật Công Nghệ');
...
--
ALTER TABLE `thoigian_xacnhan`
  MODIFY `MA_THOIGIAN_XACNHAN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `ty_le_quy_doi_gio_chuan`
--
ALTER TABLE `ty_le_quy_doi_gio_chuan`
  MODIFY `MA_QUY_DOI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 27, 2024 lúc 06:43 PM
...
(1, 'Tác giả thứ nhất', NULL),
(2, 'Tác giả chịu trách nhiệm', NULL),
(3, 'Tác giả còn lại', NULL),
(4, 'Chủ đơn', NULL),
(5, 'Đồng chủ đơn', NULL),
(6, 'Chủ biên', NULL),
(7, 'Đồng chủ biên', NULL),
(8, 'Cá nhân', NULL);
...
--
-- Cấu trúc bảng cho bảng `phan_cong_hoc_ky_nien_khoa`
--
...
--
-- Chỉ mục cho bảng `phan_cong_hoc_ky_nien_khoa`
--
ALTER TABLE `phan_cong_hoc_ky_nien_khoa`
  ADD PRIMARY KEY (`MAHKNK`,`MACHITIETPHANCONG`,`MAPHANCONG`),
  ADD KEY `FK_PHAN_CONG_HOC_KY_NIEN_KHOA2` (`MACHITIETPHANCONG`),
  ADD KEY `FK_PHAN_CONG_HOC_KY_NIEN_KHOA3` (`MAPHANCONG`);
...
--
ALTER TABLE `ty_le_quy_doi_gio_chuan`
  MODIFY `MA_QUY_DOI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
-- Các ràng buộc cho bảng `phan_cong_hoc_ky_nien_khoa`
--
ALTER TABLE `phan_cong_hoc_ky_nien_khoa`
  ADD CONSTRAINT `FK_PHAN_CONG_HOC_KY_NIEN_KHOA` FOREIGN KEY (`MAHKNK`) REFERENCES `hockynienkhoa` (`MAHKNK`),
  ADD CONSTRAINT `FK_PHAN_CONG_HOC_KY_NIEN_KHOA2` FOREIGN KEY (`MACHITIETPHANCONG`) REFERENCES `chitietphancong` (`MACHITIETPHANCONG`),
  ADD CONSTRAINT `FK_PHAN_CONG_HOC_KY_NIEN_KHOA3` FOREIGN KEY (`MAPHANCONG`) REFERENCES `bangphancong` (`MAPHANCONG`);

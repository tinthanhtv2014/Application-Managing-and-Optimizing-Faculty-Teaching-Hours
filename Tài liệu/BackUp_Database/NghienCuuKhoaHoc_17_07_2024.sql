...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 17, 2024 lúc 02:46 PM
...
(1, '99999', '2024-07-08', 'Đang giữ chức danh'),
...
(1, 1, 'Khung 1', 630, 210, 855, 285, 275, 91, NULL),
(2, 1, 'Khung 2', 810, 270, 720, 240, 230, 76, NULL),
(3, 1, 'Khung 3', 990, 330, 585, 195, 185, 61, NULL),
(4, 2, 'Khung 1', 630, 210, 765, 255, 365, 121, NULL),
(5, 2, 'Khung 2', 810, 270, 630, 210, 320, 106, NULL),
(6, 2, 'Khung 3', 990, 330, 495, 165, 275, 91, NULL),
(7, 3, 'Khung 1', 630, 210, 675, 225, 455, 151, NULL),
(8, 3, 'Khung 2', 810, 270, 540, 180, 410, 136, NULL),
(9, 3, 'Khung 3', 990, 330, 405, 135, 365, 121, NULL);
...
('baoquoczero@gmail.com', '99999', NULL, 'Giảng viên', 'Đang hoạt động'),
...
--
ALTER TABLE `khunggiochuan`
  MODIFY `MAKHUNG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

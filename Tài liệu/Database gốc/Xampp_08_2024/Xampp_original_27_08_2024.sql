/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     8/27/2024 9:57:15 PM                         */
/*==============================================================*/
...
drop table if exists PHAN_CONG_HOC_KY_NIEN_KHOA;
...
/*==============================================================*/
/* Table: PHAN_CONG_HOC_KY_NIEN_KHOA                            */
/*==============================================================*/
create table PHAN_CONG_HOC_KY_NIEN_KHOA
(
   MAHKNK               int not null,
   MACHITIETPHANCONG    int not null,
   MAPHANCONG           int not null,
   primary key (MAHKNK, MACHITIETPHANCONG, MAPHANCONG)
);
...
(
   ...
   TEN_QUY_DOI          text,
   TY_LE                float,
   VIEN_CHUC_TRUONG     varchar(50),
   THUC_HIEN_CHUAN      varchar(50),
...
alter table CO_TY_LE add constraint FK_CO_TY_LE foreign key (MA_QUY_DOI)
      references TY_LE_QUY_DOI_GIO_CHUAN (MA_QUY_DOI) on delete restrict on update restrict;

alter table CO_TY_LE add constraint FK_CO_TY_LE2 foreign key (MA_LOAI_DANH_MUC)
      references LOAI_DANH_MUC (MA_LOAI_DANH_MUC) on delete restrict on update restrict;

alter table CO_TY_LE add constraint FK_CO_TY_LE3 foreign key (MA_LOAI_TAC_GIA)
...
alter table DANG_KY_THUC_HIEN_QUY_DOI add constraint FK_DANG_KY_THUC_HIEN_QUY_DOI5 foreign key (TEN_DE_TAI)
      references NGHIEN_CUU_KH (TEN_DE_TAI) on delete restrict on update restrict;
...
alter table GIANGVIEN add constraint FK__UOC_PHAN_CONG foreign key (MAPHANCONG)
      references BANGPHANCONG (MAPHANCONG) on delete restrict on update restrict;
...
alter table PHAN_CONG_HOC_KY_NIEN_KHOA add constraint FK_PHAN_CONG_HOC_KY_NIEN_KHOA foreign key (MAHKNK)
      references HOCKYNIENKHOA (MAHKNK) on delete restrict on update restrict;

alter table PHAN_CONG_HOC_KY_NIEN_KHOA add constraint FK_PHAN_CONG_HOC_KY_NIEN_KHOA2 foreign key (MACHITIETPHANCONG)
      references CHITIETPHANCONG (MACHITIETPHANCONG) on delete restrict on update restrict;

alter table PHAN_CONG_HOC_KY_NIEN_KHOA add constraint FK_PHAN_CONG_HOC_KY_NIEN_KHOA3 foreign key (MAPHANCONG)
      references BANGPHANCONG (MAPHANCONG) on delete restrict on update restrict;

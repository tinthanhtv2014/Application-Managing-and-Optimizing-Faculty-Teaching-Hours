/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     8/3/2024 7:35:48 PM                          */
/*==============================================================*/
...
drop table if exists LUAT_QUY_DOI_GIO_CHUAN;
...
alter table CO_QUY_DINH add constraint FK_CO_QUY_DINH foreign key (MA_QUY_DOI)
      references LUAT_QUY_DOI_GIO_CHUAN (MA_QUY_DOI) on delete restrict on update restrict;
...
alter table LUAT_QUY_DOI_GIO_CHUAN add constraint FK_DUOC_QUY_DINH foreign key (MA_QUY_DINH)

/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     9/12/2024 7:09:21 PM                         */
/*==============================================================*/
...
drop table if exists CHUYEN_MON_GIANG_VIEN;
...
drop table if exists PHAN_CONG_GV_TU_DONG;
...
/*==============================================================*/
/* Table: CHUYEN_MON_GIANG_VIEN                                 */
/*==============================================================*/
create table CHUYEN_MON_GIANG_VIEN
(
   MACMGV               int not null,
   MA_GV_CMGV           varchar(255),
   MA_MON_CMGV          varchar(255),
   primary key (MACMGV)
);
...
/*==============================================================*/
/* Table: PHAN_CONG_GV_TU_DONG                                  */
/*==============================================================*/
create table PHAN_CONG_GV_TU_DONG
(
   MAPCGVTD             int not null,
   MAGV_PCGVTD          varchar(255),
   MA_MON_HOC_PCGVTD    varchar(255),
   MA_LOP_PCGVTD        varchar(255),
   DO_UU_TIEN_PCGVTD    varchar(255),
   primary key (MAPCGVTD)
);
...
alter table BANGPHANCONG add constraint FK_PHAN_CONG_HOC_KY foreign key (MAHKNK)

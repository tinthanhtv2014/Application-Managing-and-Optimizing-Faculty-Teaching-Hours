...
const createDanhMucQuyDoi = async (MA_LOAI_DANH_MUC, GIO_CHUAN, NOI_DUNG_DANH_MUC, ISBN, WOS_SCOUPUS, HANG_WOS_SCOUPUS, LOI_NHUAN, DON_VI_TINH, GIAI_THUONG, XEP_HANG_QUARTILES, NAM_THUC_HIEN, TRANG_THAI_DANH_MUC, GHI_CHU_DANH_MUC) => {
    try {
        let results1 = await selectDanhMucQuyDoi_NOI_DUNG_DANH_MUC(NOI_DUNG_DANH_MUC);
...
const updateDanhMucQuyDoi = async (id, MA_LOAI_DANH_MUC, GIO_CHUAN, NOI_DUNG_DANH_MUC, ISBN, WOS_SCOUPUS, HANG_WOS_SCOUPUS, LOI_NHUAN, DON_VI_TINH, GIAI_THUONG, XEP_HANG_QUARTILES, NAM_THUC_HIEN, TRANG_THAI_DANH_MUC, GHI_CHU_DANH_MUC) => {
    try {
        let results1 = await selectDanhMucQuyDoi_NOI_DUNG_DANH_MUC(NOI_DUNG_DANH_MUC);
        if (results1.length === 0) {
            return {

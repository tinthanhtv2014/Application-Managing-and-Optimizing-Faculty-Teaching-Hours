...
// export default DangKyDanhMucReader;
...
import CookiesAxios from "../ComponentsDangKyDanhmuc/CookiesAxios.js";
import ModalDanhMuc from "./modals/ModalselectDanhMuc.js";
import Cookies from "js-cookie";

const DangKyDanhMucReader = ({ MaGV }) => {

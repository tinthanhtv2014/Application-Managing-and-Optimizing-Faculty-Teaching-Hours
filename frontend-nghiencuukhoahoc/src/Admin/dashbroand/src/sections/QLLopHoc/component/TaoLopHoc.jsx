...
import ComponentExcelLop from "./ComponentExcelCreateLop";
const TaoLopHoc = ({ selectCTDT, setLopData, IsOpenThemLop }) => {
        ...
        if (selectCTDT && Lop.MALOP && Lop.SISO && Lop.NAMTUYENSINH && Lop.TENLOP) {
            try {
                const response = await CookiesAxios.post(
                    `${process.env.REACT_APP_URL_SERVER}/api/v1/admin/monhoc/lop/tao`,
                    {
                        Lop,
            ...
            {IsOpenThemLop == "Excel" ? (
                ...
                <>  <Box sx={{ padding: 2 }}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6} md={12}>
                            <Button variant="contained" onClick={handleThemLop}>
                                Thêm Lớp
                            </Button>
                        </Grid>
                    </Grid>
